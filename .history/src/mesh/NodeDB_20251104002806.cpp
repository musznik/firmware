...
void NodeDB::installDefaultModuleConfig()
{
    ...
    moduleConfig.dtn_overlay.ttl_minutes = 8; // DTN custody TTL
    moduleConfig.dtn_overlay.initial_delay_base_ms = 2000; 
    moduleConfig.dtn_overlay.retry_backoff_ms = 30000;   
