...
typedef enum _meshtastic_Config_DisplayConfig_DeprecatedGpsCoordinateFormat {
    /* fw+ Placeholder to satisfy proto3 enum requirement */
    meshtastic_Config_DisplayConfig_DeprecatedGpsCoordinateFormat_GPS_FORMAT_UNUSED = 0
...
#define _meshtastic_Config_DisplayConfig_DeprecatedGpsCoordinateFormat_MIN meshtastic_Config_DisplayConfig_DeprecatedGpsCoordinateFormat_GPS_FORMAT_UNUSED
#define _meshtastic_Config_DisplayConfig_DeprecatedGpsCoordinateFormat_MAX meshtastic_Config_DisplayConfig_DeprecatedGpsCoordinateFormat_GPS_FORMAT_UNUSED
#define _meshtastic_Config_DisplayConfig_DeprecatedGpsCoordinateFormat_ARRAYSIZE ((meshtastic_Config_DisplayConfig_DeprecatedGpsCoordinateFormat)(meshtastic_Config_DisplayConfig_DeprecatedGpsCoordinateFormat_GPS_FORMAT_UNUSED+1))
